...
export const PATH_DASHBOARD = {
  ...
  default: ROOTS_DASHBOARD,
  projects: ROOTS_DASHBOARD,
  ecommerce: ROOTS_DASHBOARD,
  marketing: ROOTS_DASHBOARD,
  social: ROOTS_DASHBOARD,
  bidding: ROOTS_DASHBOARD,
  learning: ROOTS_DASHBOARD,
  logistics: ROOTS_DASHBOARD,
};
